...
{
	[Table(Name = "LHXNOHPF", Schema = "XCRS")]
	public partial class LegitimacyExpirationHistoric
	{
		...
		[Column(Name = "CR1C3VA", DataType = DataType.Char, CanBeNull = false, Length = 1)]
		public string RelationshipIndicator { get; set; }
		[Column(Name = "CR1C3WA", DataType = DataType.Int32, CanBeNull = false, Precision = 9, Scale = 0)]
		...
		[Column(Name = "CR12O7A", DataType = DataType.Date, CanBeNull = false)]
		public DateTime LegEndDateExtension { get; set; }
