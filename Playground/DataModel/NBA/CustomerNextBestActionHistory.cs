...
{
	[Table(Name = "CUSTNBAX", Schema = "XCRS")]
	public partial class CustomerNextBestActionHistory
	{
		[Column(Name = "NBAIDRA", DataType = DataType.Int64, CanBeNull = false, Precision = 11, Scale = 0)]
		...
		[Column(Name = "DTECRTED", DataType = DataType.Date, CanBeNull = false)]
		public DateTime DateCreated { get; set; }
		[Column(Name = "TMECRTED", DataType = DataType.Time, CanBeNull = false)]
