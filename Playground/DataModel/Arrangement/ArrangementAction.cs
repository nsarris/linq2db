...
namespace PiraeusBank.BI.ICE2.DAL.Databases.Core.DataModel.Arrangement
{
	...
	public partial class ArrangementAction
	{
		[Column(Name = "DYNMNUID", DataType = DataType.Decimal, CanBeNull = false, Precision = 8, Scale = 0)]
		public int DynmenuId { get; set; }
		[Column(Name = "DYNMNULV", DataType = DataType.Decimal, CanBeNull = false, Precision = 7, Scale = 0)]
		...
		[Column(Name = "DISPPRIORI", DataType = DataType.Decimal, CanBeNull = false, Precision = 3, Scale = 0)]
		...
		[Column(Name = "PDYMNUID", DataType = DataType.Decimal, CanBeNull = false, Precision = 8, Scale = 0)]
