...
namespace PiraeusBank.BI.ICE2.DAL.Databases.Core.DataModel.Portfolio
{
	...
	public partial class CustomerPortfolioItem
	{
		...
		[Column(Name = "GRPIPID", DataType = DataType.Decimal, CanBeNull = false, Precision = 8, Scale = 0)]
		...
		[Column(IsPrimaryKey = true, Name = "IPIDCRA", DataType = DataType.Decimal, CanBeNull = false, Precision = 8, Scale = 0)]
		public int IpId { get; set; }
		[Column(Name = "CR6FA", DataType = DataType.Decimal, CanBeNull = false, Precision = 11, Scale = 0)]
		...
		[Column(Name = "CR1C6A", DataType = DataType.Decimal, CanBeNull = false, Precision = 3, Scale = 0)]
		...
		[Column(Name = "CSTMIPID", DataType = DataType.Decimal, CanBeNull = false, Precision = 8, Scale = 0)]
