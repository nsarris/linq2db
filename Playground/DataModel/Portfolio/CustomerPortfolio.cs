...
{
	[Table(Name = "CRS13TP", Schema = "XCRS")]
	public partial class CustomerPortfolio
	{
		[Column(IsPrimaryKey = true, Name = "CR4OSA", DataType = DataType.Char, CanBeNull = false, Length = 25)]
		public string Username { get; set; }
		[Column(IsPrimaryKey = true, Name = "PDLVL1CD", DataType = DataType.Char, CanBeNull = false, Length = 7)]
		public string ProductLevel1 { get; set; }
		[Column(IsPrimaryKey = true, Name = "PDLVL2CD", DataType = DataType.Char, CanBeNull = false, Length = 7)]
		public string ProductLevel2 { get; set; }
		[Column(IsPrimaryKey = true, Name = "PDLVL3CD", DataType = DataType.Char, CanBeNull = false, Length = 7)]
		public string ProductLevel3 { get; set; }
		[Column(IsPrimaryKey = true, Name = "GRPIPID", DataType = DataType.Int32, CanBeNull = false, Precision = 8, Scale = 0)]
		public int GroupsIpId { get; set; }
		[Column(IsPrimaryKey = true, Name = "PDTYCLTY", DataType = DataType.Char, CanBeNull = false, Length = 3)]
		...
		[Column(IsPrimaryKey = true, Name = "CR6FA", DataType = DataType.Int64, CanBeNull = false, Precision = 11, Scale = 0)]
		public long ArrangementId { get; set; }
		[Column(IsPrimaryKey = true, Name = "ARIPCLTY", DataType = DataType.Char, CanBeNull = false, Length = 3)]
