...
{
	[Table(Name = "CONTCAT", Schema = "XCRS")]
	public partial class ContactCategory
	{
		...
		[Column(Name = "CATNAME", DataType = DataType.VarChar, CanBeNull = false, Length = 200)]
		public string Name { get; set; }
		[Column(Name = "CATTITLE", DataType = DataType.VarChar, CanBeNull = false, Length = 200)]
